...
The Building 1 router was configured using the CLI. The configuration you can see below:
...
Building1#reload
```
Other routes were configured based on Building 2 router configuration according to their subnets.
Unfortunately, I was limited in the amount of time for a task, PT limitations, and performance when handling high loads, this did not allow me to fully reveal my knowledge in bonus projects, including designing in a physical mode.

Demo of network operation:
...
The router was configured on the basis of previous jobs.
