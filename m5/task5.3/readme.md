...
Complete life cycle of process can be circle as –
...
```/proc``` directory is pseudo-filesystem in which the kernel exposes a variety of interesting information about the system’s state.
